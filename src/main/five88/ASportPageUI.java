...
public class ASportPageUI {
    ...
    public static By betOrderLocator = By.xpath("//div[@class='quickBetPanel']//div[@class='betDetail']");
    public static By betTicketLocator = By.xpath("//div[@class='betlist__content']//div[@class='betDetail']");
