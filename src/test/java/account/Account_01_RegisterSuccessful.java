...
public class Account_01_RegisterSuccessful extends CommonsTest {
	...
	private final String USERNAME_6 = "auto_" + randomString(1, true, true);
	private final String USERNAME_30 = "auto_seta" + randomString(21, true, true);
	...
	public void TC_01_RegisterSuccessful(Method method) {
		try {
			...
			String USERNAME_TODAY = "auto_seta" + new java.text.SimpleDateFormat("yyyyMMddHHmmss").format(new Date());
...
//	}
	...
	public void TC_04_RegisterSuccessfulWithPass6Letters(Method method) {
		try {
			...
			String USERNAME_PASS6 = "auto_seta" + new java.text.SimpleDateFormat("yyyyMMddHHmmss").format(new Date());
	...
	public void TC_05_RegisterSuccessfulWithPhone14Letters(Method method) {
		try {
			...
			String USERNAME_PHONE14 = "auto_seta" + new java.text.SimpleDateFormat("yyyyMMddHHmmss").format(new Date());
